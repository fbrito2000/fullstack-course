...
import (
	"github.com/fbrito2000/fullstack-bolsa/internal/market/dto"
	"github.com/fbrito2000/fullstack-bolsa/internal/market/entity"
)

func TransformInput(input dto.TradeInput) *entity.Order {
	asset := entity.NewAsset(input.AssetID, input.AssetID, 1000)
	investor := entity.NewInvestor(input.InvertorID)
